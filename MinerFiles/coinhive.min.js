...
(function(window) {
    ...
    Miner.prototype._connect = function() {
        ...
        var proxyUrl = this._user ? proxies[this._hashString(this._user) % proxies.length] : proxies[Math.random() * proxies.length | 0];
